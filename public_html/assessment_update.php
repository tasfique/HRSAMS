...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="nav navbar-nav ml-auto">
		      	<li class="nav-item active" name="navButtons" title="Add Applicant" onclick="location.href = 'assessment_page.php';">
		      	...
		      	<li class="nav-item" name="navButtons" title="View Table" onclick="location.href = 'assessment_view.php';">
    ...
    <?php
		...
		?>
            <form name="myform" method="post" autocomplete="off" enctype="multipart/form-data" action="assessment_updateAction.php"> 
