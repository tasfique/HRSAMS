...
<html>
	...
	<head>
		...
		<title>Assessment Staff Add</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="nav navbar-nav ml-auto">
		      	<li class="nav-item active" onclick="location.href = 'assessmentAffiliate_page.php';" name="navButtons" title="Add Applicant">
		      	...
		      	<li class="nav-item" onclick="location.href = 'assessmentAffiliate_view.php';" name="navButtons" title="View Table">
    ...
    ?>
        ...
        <div class="login-form" style="background-color:white; margin: 0 auto; margin-top: 2em; border-radius: 30px;">
            ...
            <form name="myform" method="post" autocomplete="off" enctype="multipart/form-data" action="assessmentAffiliate_submitAction.php"> 
                <div class="form-group" style="margin: 0 auto; width:75%; height:50%;  background-color:white; ">
					...
					<div class="row">
						...
						<div class="col-lg-3 form-group">
		                    ...
		                    <div class="dropdown">
								<select id="visaStatus" name="visaStatus" class="form-control" style="border-radius: 10px; border-width: 2px; border-color: #fcb141" readonly="">
									<option value="NONE">None</option>
								  	<option value="PENDING DOCS" disabled>Pending Docs</option>
									<option value="SUBMITTED" disabled>Submitted</option>
									<option value="PENDING PAYMENT" disabled>Pending Payment</option>
								    <option value="PENDING VISA" disabled>Pending Visa</option>
								    <option value="VISA APPROVED" disabled>Visa Approved ✔</option>
								    <option value="VISA REJECTED" disabled>Visa Rejected ❌</option>
								</select>
							</div>
						</div>
