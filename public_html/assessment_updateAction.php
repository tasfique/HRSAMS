<?php
	...
	// 	echo "Successfully Added! <br /><a href='assessment_update.php?applicantID=$applicantID.php'>Go back</a>";
	// }
	// else {
	// 	echo '<script>alert("Failed to ADD, There might be duplicate Passport Number or Database Issue")</script>';
	// 	echo "Failed! <br /><a href='assessment_update.php?applicantID=$applicantID.php'>Go back</a>";
	// }
