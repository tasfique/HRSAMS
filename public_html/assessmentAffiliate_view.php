<?php
	...
	$sql = "SELECT * FROM APPLICANTS WHERE affiliateCode = '$affiliateCode'";
...
<html>
	...
	<head>
		...
		<title>Assessment Staff View</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
			  ...
			  <div class="collapse navbar-collapse" id="navbarNav">
			    <ul class="nav navbar-nav ml-auto">
			      	<li title="Add Applicant" class="nav-item" onclick="location.href = 'assessmentAffiliate_page.php';">
			      	...
			      	<li title="View Table" class="nav-item active" onclick="location.href = 'assessmentAffiliate_view.php';">
					  ...
					  <?php
					  	if($r) {
					  		...
					  		while($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
					  			...
					  			<br>
					  			&nbsp;
                                <a class='btn btn-warning' href='assessmentAffiliate_update.php?applicantID=".$row['applicantID']."'><img src='assets/edit-icon.png'></a> &nbsp; &nbsp; &nbsp;
