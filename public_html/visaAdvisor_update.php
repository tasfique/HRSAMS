...
<html>
	...
	<head>
		...
		<title>Visa Advisor Update</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="nav navbar-nav ml-auto">
		      	<li class="nav-item active" name="navButtons" title="Add Applicant" onclick="location.href = 'visaAdvisor_page.php';">
		      	...
		      	<li class="nav-item" name="navButtons" title="View Table" onclick="location.href = 'visaAdvisor_view.php';">
    ...
    <?php
		...
		?>
            <form name="myform" method="post" autocomplete="off" enctype="multipart/form-data" action="visaAdvisor_updateAction.php"> 
                <div class="form-group" style="margin: 0 auto; width:75%; height:50%;  background-color:white; ">
					...
					<div class="row">
						<div class="col-lg-3 form-group">
		                    ...
		                    <div class="dropdown">
								<select id="applicationStatus" name="applicationStatus" class="form-control" style="border-radius: 10px; border-width: 2px; border-color: #fcb141">
								  	<option value="NONE" <?php if($row['applicationStatus']=="NONE") echo 'selected="selected"'; ?>
								  	>None</option>
								  	<option value="KIV" 
						...
						<div class="col-lg-3 form-group">
							<label for="visaStatus" style="font-size:18px;">Visa Status:</label>
		                    <div class="dropdown">
