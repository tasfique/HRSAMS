...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="nav navbar-nav ml-auto">
		      	...
		      	<li class="nav-item" name="navButtons" title="View Table" onclick="location.href = 'manager_view.php';">
		      	...
		      	<li class="nav-item" name="navButtons" title="Change Password" onclick="location.href = 'manager_password.php';">
    ...
    <?php
		...
		?>
            <form name="myform" method="post" autocomplete="off" enctype="multipart/form-data" action="manager_updateAction.php"> 
                <div class="form-group" style="margin: 0 auto; width:75%; height:50%;  background-color:white; ">
                    ...
                    <div class="row">
						...
						<div class="col-lg-4 form-group">
							...
							<input style="border-radius: 10px; border-width: 2px; border-color: #fcb141" type="text" class="form-control" id="passportNo" name="passportNumber" placeholder="example, K3639262" value="<?php echo $row['passportNumber'];?>" required>
					...
					<div class="row">
						<div class="col-lg-3 form-group">
		                    ...
		                    <div class="dropdown">
								<select name="applicationStatus" id="applicationStatus" class="form-control" style="border-radius: 10px; border-width: 2px; border-color: #fcb141">
									<option value="NONE" 
						...
						<div class="col-lg-3 form-group">
		                    ...
		                    <div class="dropdown">
								<select name="visaStatus" id="visaStatus" class="form-control" style="border-radius: 10px; border-width: 2px; border-color: #fcb141">
									<option value="NONE" 
					...
					<div class="row">
                        <div class="col-lg-3 form-group">
								<label for="billingAmount" style="font-size:18px;">Billing Amount:</label>
								<input style="border-radius: 10px; border-width: 2px; border-color: #fcb141" type="text" class="form-control" id="billingAmount" name="billingAmount" placeholder="Enter Amount" value="">
						</div>
					    <p id="buttonEmail" class="col-lg-4 form-group" style="margin: auto;">
    	                    <input name="emailSub" type="submit" value="Send Bill" class="btn btn-success" id="myBtnEmail" style="border-radius: 10px; width:100%; height:50px;font-size:20px;">
    	                </p>
