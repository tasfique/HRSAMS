<?php
    ...
    $username = "u477792429_hrsams";
    $password = "#b>ph*6NeUDMRj#q";
    $dbname = "u477792429_hr_ams";
...
// 	if($result === true) {
// 		echo "Successfully deleted! <br /><a href='manager_view.php'>Go back</a>";
// 	}
// 	else {
// 		echo "Failed to delete the data! <br /><a href='manager_view.php'>Go back</a>";
// 	}
?>
...
<script>
	...
	{
	    location.href = "manager_view.php";
	}
