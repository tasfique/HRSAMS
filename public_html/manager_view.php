        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
			  ...
			  <div class="collapse navbar-collapse" id="navbarNav">
			    <ul class="nav navbar-nav ml-auto">
			      	<li title="Add Applicant" class="nav-item" onclick="location.href = 'manager_page.php';">
			      	...
			      	<li title="View Table" class="nav-item active" onclick="location.href = 'manager_view.php';">
			      	...
			      	<!-- </form> -->
			      	<li title="Change Password" class="nav-item" onclick="location.href = 'manager_password.php';">
					  ...
					  <?php
					  	if($r) {
					  		...
					  		while($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
					  			...
					  			<td>".$row['applicantID']."
					  			&nbsp;
					  			<a class='btn btn-warning' href='manager_update.php?applicantID=".$row['applicantID']."'><img src='assets/edit-icon.png'></a> <br> <br>
					  			<a class='btn btn-danger' href='manager_deleteAction.php?applicantID=".$row['applicantID']."'
					  			><img src='assets/delete-icon.png'></a> &nbsp; &nbsp;
