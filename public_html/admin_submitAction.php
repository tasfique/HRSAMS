...
// 		$email = $_POST['email'];
// 		$emailSender = "notification@hrsams.com";

// 		$to = $email;
// 		$subject = 'Agensi Perkajaan HRs - Application Status';
// 		$message = "Greetings, Mr/Mrs ".$lastName.",\n\n"."We have received your application in our Application Management System for processing.\nOur Assessment Staff will conduct an initial assessment and will notify you of any further proceeding.\n\nThank you for your patience and picking Agency HR'S Management.";
...
// 	}
	...
	// if($result === true) {
	// 	// header("refresh:3;url=http://localhost/hr_ams/admin_page.php");
	// 	echo '<script>alert("SUCCESSFULLY ADDED")</script>';
	// 	echo "Successfully Added! <br /><a href='admin_page.php'>Go back</a>";

	// }
	// else {
	// 	// header("refresh:3;url=http://localhost/hr_ams/admin_page.php");
	// 	echo '<script>alert("Failed to ADD, There might be duplicate Passport Number or Database Issue")</script>';
	// 	echo "Failed! <br /><a href='admin_page.php'>Go back</a>";
