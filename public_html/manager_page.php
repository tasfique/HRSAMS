...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fff7eb;">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="nav navbar-nav ml-auto">
		      	<li class="nav-item active" onclick="location.href = 'manager_page.php';" name="navButtons" title="Add Applicant">
    ...
    ?>
        ...
        <div class="login-form" style="background-color:white; margin: 0 auto; margin-top: 2em; border-radius: 30px;">
            ...
            <form name="myform" method="post" autocomplete="off" enctype="multipart/form-data" action="manager_submitAction.php"> 
